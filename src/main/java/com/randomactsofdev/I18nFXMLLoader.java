 ...
 * @since JavaFX 2.0
 */
public class I18nFXMLLoader {
	private static Logger LOG = LogManager.getLogger(I18nFXMLLoader.class);
	public static final String I18NKEY = "i18n";
    ...
    private abstract class Element {
        ...
        //Process property attributes, storing the i18n key for later
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    return aValue;
                        ...
                        if (aValue.charAt(0) == '/') {
                            ...
                            try {
                                return new URL(I18nFXMLLoader.this.location, aValue).toString();
                            } catch (MalformedURLException e) {
                                System.err.println(I18nFXMLLoader.this.location + "/" + aValue);
                            }
                        }
                }
            ...
            if (parent == null) {
                ...
                if (defaultNSURI != null) {
                    ...
                    if (compareJFXVersions(JAVAFX_VERSION, nsVersion) < 0) {
                    	LOG.warn("Loading FXML document with JavaFX API of version " +
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = I18nFXMLLoader.this.resources;
        public Charset charset = I18nFXMLLoader.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            I18nFXMLLoader.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (I18nFXMLLoader.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(I18nFXMLLoader.this.location, source);
            }

            I18nFXMLLoader fxmlLoader = new I18nFXMLLoader(location, resources,
                builderFactory, controllerFactory, charset,
                loaders);
            fxmlLoader.parentLoader = I18nFXMLLoader.this;

            if (isCyclic(I18nFXMLLoader.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                        "Including \"%s\" in \"%s\" created cyclic reference.",
                        fxmlLoader.location.toExternalForm(),
                        I18nFXMLLoader.this.location.toExternalForm()));
            }
    ...
    private final LinkedList<I18nFXMLLoader> loaders;

    private ClassLoader classLoader = null;
    private boolean staticLoad = false;
    private LoadListener loadListener = null;

    private I18nFXMLLoader parentLoader;
     ...
     * @since JavaFX 2.1
     */
    public I18nFXMLLoader(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public I18nFXMLLoader(URL location, ResourceBundle resources) {
     ...
     * @since JavaFX 2.1
     */
    public I18nFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     * @param charset
     */
    public I18nFXMLLoader(Charset charset) {
	...
	public I18nFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
        Callback<Class<?>, Object> controllerFactory, Charset charset,
        LinkedList<I18nFXMLLoader> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof I18nFXMLLoader) {
            I18nFXMLLoader loader = (I18nFXMLLoader)obj;
    ...
    @SuppressWarnings({ "dep-ann", "unchecked", "unused" })
    ...
    private String constructFXMLTrace() {
        ...
        for (I18nFXMLLoader loader : loaders) {
        ...
        if (defaultClassLoader == null) {
            ...
            if (sm != null) {
                final ClassLoader callerClassLoader = (caller != null) ?
                        ...
                        null;
                if (needsClassLoaderPermissionCheck(callerClassLoader, I18nFXMLLoader.class.getClassLoader())) {
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        I18nFXMLLoader.defaultClassLoader = defaultClassLoader;
    }
     ...
     */
    @CallerSensitive
    public static <T> T load(URL location, Object root, Object controller) throws IOException {
    ...
    private static <T> T loadImpl(URL location, Class<?> callerClass, Object root, Object controller)
            throws IOException {
        return loadImpl(location, null, callerClass, root, controller);
    }
    ...
    public static <T> T load(URL location, ObservableResourceFactory resourceFactory,
                             ...
                             Object controller)
                                     throws IOException {
        return loadImpl(location, resourceFactory, builderFactory,
                        (System.getSecurityManager() != null)
                            ? Reflection.getCallerClass()
                            : null,
                            root,
    ...
    private static <T> T loadImpl(URL location, ObservableResourceFactory resourceFactory,
        ...
        return loadImpl(location, resourceFactory, builderFactory, null, callerClass, root, controller);
    }
    ...
    public static <T> T load(URL location, ObservableResourceFactory resourceFactory,
                             ...
                             Object controller)
                                     throws IOException {
        return loadImpl(location, resourceFactory, builderFactory, controllerFactory,
                        (System.getSecurityManager() != null)
                            ? Reflection.getCallerClass()
                            : null,
                            root,
    ...
    private static <T> T loadImpl(URL location, ObservableResourceFactory resourceFactory,
        ...
        I18nFXMLLoader fxmlLoader =
                new I18nFXMLLoader(location, resourceFactory.getResources(), builderFactory,
                               controllerFactory, charset);
        
        fxmlLoader.setRoot(root);
        fxmlLoader.setController(controller);

        final T parent = fxmlLoader.<T>loadImpl(callerClass);
        
        //Add observers to the nodes to observe (language) changes in the resource
        if (parent instanceof Node) {
        	addObservers((Node)parent, resourceFactory);
        }
    ...
    private static void addObservers(final Node parent, final ObservableResourceFactory resourceFactory) {
    	if (parent instanceof Labeled) {
    		...
    		if (i18nlabel != null && i18nlabel.length()>=2) {
    			//Bind the text value of the label to the observed resource. In this case the resource is
    			// keyed to the pre-internationalised text value e.g. %main.enterbutton. The leading % needs
    			// stripping off before using the key to look up the internationalised text
    			((Labeled)parent).textProperty().bind(resourceFactory.getStringBinding(i18nlabel.substring(1)));
    		}
    	}
    	
    	if (parent instanceof Parent) {
	    	for (Node node : ((Parent)parent).getChildrenUnmodifiable()) {
	    		addObservers(node, resourceFactory);
	    	}
    	}
    }
}
